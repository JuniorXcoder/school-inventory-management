                    ...
                    <div class="panel-heading bg-primary"><h3 class="text-white">Table Transaksi</h3></div>
                      ...
                      <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        ...
                                        $no = 1;
                                        $sql = $koneksi->query("SELECT * FROM `transaksi` WHERE `jam_keluar` LIKE '%$hari%' OR `status` LIKE 'Dipinjam'");
                        ...
                        <a href="./page/report/export-transaksi-2-excel-harian.php" class="btn btn-default" style="margin-top: 10px"><i class="fa fa-print 1x"></i> Export To Excel </a>
                        <a href="./page/report/export-transaksi-2-pdf-harian.php" class="btn btn-default" style="margin-top: 10px"><i class="fa fa-print"></i> Export To PDF </a></div></div></div></div>